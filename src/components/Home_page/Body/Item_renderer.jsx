...
export default class Items extends Component {
  ...
  state = {
    ...
    Other_kits: [
            ...
            {id : 5, img_src: "something", price: 0 , Qty_available:1 , Qty_selected: 0, name: "something", color: "something"},
            {id : 6, img_src: "something", price: 0 , Qty_available:0 , Qty_selected: 0, name: "something", color: "something"},
            {id : 7, img_src: "something", price: 0 , Qty_available:0 , Qty_selected: 0, name: "something", color: "something"},
            {id: 8, img_src: "something", price: 0, Qty_available: 0, Qty_selected: 0, name: "something", color: "something"}
    ]
  }
  ...
  handleAddBest = (kitId) => {
    ...
    console.log(this.state.Promo_kits[kitId].name);
